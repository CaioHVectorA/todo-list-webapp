...
const Form = () => {
  ...
  const { guestMode, setGuestMode } = useContext(UserContext);
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", width: "70%" }}>
      <h1 style={{ textAlign: "center" }}>
        {!loginMode
          ? "Crie sua Conta para a experiência completa de To-Do"
          : "Bem vindo de volta!"}
      </h1>
      <div
        style={{
      ...
      >
        ...
        <S.Input
          ...
          value={password}
        />
        <S.Button onClick={HandleSubmit} style={{ marginTop: "32px" }}>
          ENTRAR
        </S.Button>
      </div>
      <div
      ...
      >
        ...
        >
          {!loginMode ? "Já tenho uma conta." : "Quero criar uma conta"}
        </p>
        <p
          onClick={() => {
            setGuestMode(true);
    ...
    return (
      <div
        style={{
          ...
          paddingTop: "64px",
          background:
            "linear-gradient(90.53deg, #A3AAE8 0.44%, #4b88e4 99.54%)",
      ...
      >
        ...
        >
          <h1 style={{ fontSize: "49px", marginTop: "32px" }}>
            Booste seus projetos.{" "}
          </h1>
          <p style={{ marginTop: "32px", width: "400px", fontSize: "20px" }}>
            Monte inúmeras grade de tarefas para você ou sua equipe e
            personalidade assim como quiser!
          </p>
          <S.Button onClick={() => setStep(2)} style={{ marginTop: "20px" }}>
            COMEÇAR AGORA
          </S.Button>
        </div>
        <div
            ...
            <g>
              ...
              <g>
                ...
                <path
                  ...
                  fill="#6776f8"
                />
                <circle cx="159.97525" cy="246.53845" r="9" fill="#6776f8" />
                <path
                  ...
                  fill="#3f3d56"
                />
                <circle cx="159.97525" cy="299.53845" r="9" fill="#6776f8" />
                <path
                  ...
                  fill="#3f3d56"
                />
                <circle cx="159.97525" cy="352.53845" r="9" fill="#6776f8" />
                <path
